...
from app.schemas.search import QuerySection, SearchRequest
from app.schemas.search_augmented import AugmentedSearchResponse
...
async def search_with_augmentation(request: SearchRequest):
    ...
    try:
        ...
        logger.info(f"[AUGMENTED SEARCH] 🚀 Running 3-PASS parallel search (Q0, Q1, Q2)")
        logger.info(f"[AUGMENTED SEARCH] Q0='{query_text}', Q1='{q1_text}', Q2='{q2_text}'")
